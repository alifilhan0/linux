...
static const struct mtk_mmsys_routes mt6735_mmsys_routing_table[] = {
	/* OVL -> COLOR */
	{
		...
		MT6735_DISP_OVL0_MOUT_EN,
		MT6735_DISP_OVL0_MOUT_EN_MASK,
		MT6735_DISP_OVL0_MOUT_COLOR,
	}, {
		DDP_COMPONENT_OVL0,
		DDP_COMPONENT_COLOR0,
		MT6735_DISP_COL0_SEL_IN,
		MT6735_DISP_COL0_SEL_IN_MASK,
		MT6735_DISP_COL0_IN_OVL0,
	},
	/*
	...
	/* DITHER -> RDMA0 */
	{
		...
		DDP_COMPONENT_RDMA0,
		MT6735_DISP_DITHER_MOUT_EN,
		MT6735_DISP_DITHER_MOUT_EN_MASK,
		MT6735_DISP_DITHER_MOUT_RDMA0
	},
	/* RDMA0 -> DSI */
	{
		DDP_COMPONENT_RDMA0,
		DDP_COMPONENT_DSI0,
		MT6735_DISP_RDMA0_SOUT_SEL_IN,
		MT6735_DISP_RDMA0_SOUT_SEL_IN_MASK,
		MT6735_DISP_RDMA0_SOUT_DSI
	}, {
		DDP_COMPONENT_RDMA0,
		DDP_COMPONENT_DSI0,
		MT6735_DISP_DSI0_SEL_IN,
		MT6735_DISP_DSI0_SEL_IN_MASK,
		MT6735_DISP_DSI0_IN_RDMA0
	},
};
